...
<html lang="en">
  ...
  <body>
    ...
    >
      <a href="courses.php" class="w3-bar-item w3-button w3-center">Record </a>
      <a href="tutors.php" class="w3-bar-item w3-button w3-center">Profile</a>
      <a href="#subscription" class="w3-bar-item w3-button w3-center">List</a>
      <a href="#profile" class="w3-bar-item w3-button w3-center">Search</a>
    </div>
    ...
    <div class="w3-bar w3-grey">
        <a href="register.php" class="w3-bar-item w3-button w3-right">New User</a>
    </div>
    ...
    <div class="w3-margin w3-border" style="overflow-x:auto;">
        ...
        echo "<table class='w3-table w3-striped w3-bordered' style='width:100%'>
         <tr><th style='width:5%'>User_id</th><th style='width:10%'>First_name</th><th style='width:10%'>Last_name</th><th style='width:10%'>Gender</th><th style='width:10%'>Identity_card_number</th>
...
// `Phone_Number`, `Home_Address`, `otp`, `user_type` FROM `user_profile` WHERE 1
            ...
            echo "<tr><td>$i</td><td>$First_name</td><td>$Last_name</td><td>$Gender</td><td>$Identity_card_number</td><td>$Email</td>
            <td>$Password</td><td>$Phone_Number</td><td>$Home_Address</td><td>$user_type</td>
            <td><button class='btn'><a href='userTable.php?submit=delete&prid=$prid' class='fa fa-trash' onclick=\"return confirm('Are you sure?')\"></a></button>
            <button class='btn'><a href='UpdateuserTable.php?submit=details&prid=$prid' class='fa fa-edit'></a></button></td></tr>";
        }
        //userTable
        echo "</table>";
        ?>
    ...
    <?php
        ...
        for ($page = 1; $page <= $number_of_page; $page++) {
            echo '<a href = "userTable.php?pageno=' . $page . '" style=
